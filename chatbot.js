(function () {
    ...
    wrapper.innerHTML = `
      <div class="chat-widget" data-chat-widget>
        <div class="chat-panel" data-chat-panel hidden>
          ...
          <form class="chat-contact-form" data-chat-contact-form name="chat-enquiry" method="POST" data-netlify="true" netlify-honeypot="chat-bot-field" action="/thank-you.html" hidden>
  ...
  contactForm.addEventListener('submit', (e) => {
    ...
    const subject = encodeURIComponent(`Website chat enquiry - ${matter}`);
